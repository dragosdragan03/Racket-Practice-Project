...
(define-syntax-rule (collection-append s1 s2) (stream-append s1 s2))
(define-syntax-rule (collection-foldl f i s) (stream-fold f i s))
(define-syntax-rule (collection-filter f s) (stream-filter f s))
