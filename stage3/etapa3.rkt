...
(define (longest-common-substring text1 text2)
  (let* ([suffixes-tree (text->ast text1)] ; st pentru primul text
    ...
    (let verify ((st suffixes-tree) (suf-list suffixes-list) (result '())) ; folosesc named let pentru a parcurge lista de sufixe 
      (if (null? suf-list)                                                 ; si de a construi lista cu cele mai lungi substringuri
